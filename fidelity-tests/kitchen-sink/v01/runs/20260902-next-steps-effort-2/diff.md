...
- **unexpected** `tab[Tab 1]/para[23:Ship the v2 migration script v].style@"v2 migration script"`
  - before: `{"textStyle": {"strikethrough": true}}`
  - after:  `{"textStyle": {}}`
- **unexpected** `tab[Tab 1]/para[23:Ship the v2 migration script v].style@"Estimated effort"`
  - before: `{"textStyle": {"backgroundColor": {"color": {"rgbColor": {"green": 1, "red": 1}}}}}`
  - after:  `{"textStyle": {}}`
- **expected** `tab[Tab 1]/para[23:Ship the v2 migration script v].text`
  - before: `"3"`
  - after:  `"4"`
