...
- **expected** `tab[Tab 1]/para[new@19:Get added to the on-call rota ].text`
  - before: `"∅"`
  - after:  `"Get added to the on-call rota (ask Marco)⏎"`
- **expected** `tab[Tab 1]/para[new@19:Get added to the on-call rota ].bullet`
  - before: `"∅"`
  - after:  `{"listId": "kix.i11mp0ghmsa2", "textStyle": {}}`
- **expected** `tab[Tab 1]/para[new@19:Get added to the on-call rota ].paragraphStyle`
  - before: `"∅"`
