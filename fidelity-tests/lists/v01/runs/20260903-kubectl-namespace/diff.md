...
- **unexpected** `tab[Tab 1]/para[41:Kubectl rollout restart deploy].style@"Kubectl rollout restart deploy/api"`
  - before: `{"textStyle": {"fontSize": {"magnitude": 10, "unit": "PT"}, "weightedFontFamily": {"fontFamily": "Courier New", "weight": 400}}}`
  - after:  `{"textStyle": {}}`
- **expected** `tab[Tab 1]/para[41:Kubectl rollout restart deploy].text`
  - before: `""`
  - after:  `"-eu"`
